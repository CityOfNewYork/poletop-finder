...
const poletop = {
  ...
  GROUPED_DATA_URL: 'https://data.cityofnewyork.us/resource/tbgj-tdd6.csv?$select=community_board,count(community_board)%20as%20count&$where=equipment_installed_yes_no=%27Y%27&$group=community_board&$limit=50000',
